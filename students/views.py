        ...
        try:
            ...
            with transaction.atomic():
                ...
                if 'total_fee_amount' in data or 'amount_paid' in data:
                    from decimal import Decimal
                    total_fee = Decimal(str(student.total_fee_amount or 0))
                    amount_paid = Decimal(str(student.amount_paid or 0))
                    student.balance_due = max(Decimal('0'), total_fee - amount_paid)
                    student_updated = True
